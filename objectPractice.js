...
//     for(var value in customerData[name]){
//     if(name === firstName && customerData[name][value] === 1){
//       greeting = 'Welcome back, ' + firstName + "! We're glad you liked us the first time!";
//     }
//     else if(name === firstName && customerData[name][value] >1){
...
// console.log(greetCustomer(customerData));
...
//     } else if (user["id"] % 2 === 0){
//       output.push(user["address"]["street"] + ", " + user["address"]["suite"] + ", " + user["address"]["city"] + ", " + user["address"]["zipcode"]);
//     }
//   }
